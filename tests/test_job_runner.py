...
from cli.job_runner import retry_patch, update_application_pods, rollback_application_pods, write_metrics
...
def test_update_application_pods_no_pods(mock_load_config, mock_core_api, mock_k8s_client):
